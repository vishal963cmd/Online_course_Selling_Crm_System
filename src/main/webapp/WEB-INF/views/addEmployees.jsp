                ...
                <div class="card-body p-4 text-center">
                    ...
                    <form:form action="addEmpForm" method="POST" modelAttribute="modelEmpattr">
                        ...
                        <div class="form-group text-start mb-4">
                            ...
                            <form:input path="name" id="name" cssclass="form-control form-control-lg" placeholder="Enter name" />
                        </div>
                        
                        <div class="form-group text-start mb-4">
                            <label for="email" class="form-label text-dark fw-bold mb-2">Enter Email</label>
                            <form:input path="email" id="email" cssclass="form-control form-control-lg" placeholder="Enter email" />
                        </div>
                        
                        <div class="form-group text-start mb-4">
                            <label for="password" class="form-label text-dark fw-bold mb-2">Enter Password</label>
                            <form:password path="password" id="password" cssclass="form-control form-control-lg" placeholder="********" />
                        </div>
                        
                        <div class="form-group text-start mb-5">
                            <label for="phone" class="form-label text-dark fw-bold mb-2">Enter Phone No.</label>
                            <form:input path="phoneno" id="phone" cssclass="form-control form-control-lg" placeholder="Enter phoneno" />
                        </div>
                        
                        <div class="d-grid gap-2">
                            <input type="submit" class="btn btn-primary btn-lg fw-bold custom-register-btn" value="Register" />
                        </div>
